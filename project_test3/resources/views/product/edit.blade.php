...
<form action="{{route('edit',['id'=>$products->id])}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" value="{{ $products->gender }}" name="gender">
    </div>
    <div class="mb-3">
        <label for="phone" class="form-label">phone</label>
        <input type="number" class="form-control" value="{{$products->phone}}" name="phone" >
      </div>
    <div class="mb-3">
        <label for="address" class="form-label">addres</label>
        <input type="text" class="form-control" value="{{ $products->address }}" name="address" >
      </div>
